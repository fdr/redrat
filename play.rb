...
def test_roundtrip
  banner 'Round-trip a Ruby value to Python and Back'
  dict = builtins[u'dict']
  puts builtins[u'eval'].call(
    U-"lambda x: x", dict.call, dict.call).call 'just ruby'
end
...
pe {
  ...
  parser.add_argument(u'--roundtrip') { |kw|
    kw[:action] = u'store_true'
    kw[:help] = u'push a raw Ruby object into Python'
  }
